...
echo ""
echo "For urxvt terminal issues, try these additional tests:"
echo "1. Test without picom: ./disable-picom-test.sh"
echo "2. Test with minimal picom: cp .config/picom/picom-minimal.conf ~/.config/picom/picom.conf && killall picom && picom &"
echo ""
